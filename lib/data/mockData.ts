...
export const mockRequests: Request[] = [
  { id: 'REQ-001', customerId: 'C001', customerName: 'Jasur Toshmatov', type: 'complaint', priority: 'high', status: 'new', message: "Ko'ylak hajmi noto'g'ri keldi, almashtirish kerak.", createdAt: '2026-06-04', notes: '', source: 'web' },
  { id: 'REQ-002', customerId: 'C003', customerName: 'Bobur Xasanov', type: 'return', priority: 'high', status: 'in-progress', message: 'Kurtka rangi bir haftadan so\'ng o\'zgarib qoldi. Qaytarish so\'raladi.', createdAt: '2026-06-02', notes: 'Mijoz bilan bog\'lanildi, qaytarish tasdiqlandi.', source: 'web' },
  { id: 'REQ-003', customerId: 'C005', customerName: 'Sardor Rahimov', type: 'inquiry', priority: 'medium', status: 'resolved', message: 'Yangi to\'plam qachon kelishini so\'ramoqda.', createdAt: '2026-05-28', notes: "Iyul oyida yangi to'plam kelishi haqida xabar berildi.", source: 'web' },
  { id: 'REQ-004', customerId: 'C012', customerName: 'Dilnoza Hamidova', type: 'complaint', priority: 'medium', status: 'in-progress', message: 'Libosning tikmasi sifatsiz, bir kunda yirtildi.', createdAt: '2026-06-03', notes: 'Sifat nazorat bo\'limiga yuborildi.', source: 'web' },
  { id: 'REQ-005', customerId: 'C015', customerName: 'Jahongir Ibrohimov', type: 'inquiry', priority: 'low', status: 'new', message: 'VIP chegirma shartnomasi haqida ma\'lumot olmoqchi.', createdAt: '2026-06-05', notes: '', source: 'web' },
  { id: 'REQ-006', customerId: 'C007', customerName: 'Ulugbek Abdullayev', type: 'return', priority: 'high', status: 'resolved', message: "Palto o'lchamlari farq qildi. To'liq qaytarish talab qilinadi.", createdAt: '2026-05-20', notes: 'Pul qaytarildi.', source: 'web' },
  { id: 'REQ-007', customerId: 'C002', customerName: 'Nilufar Karimova', type: 'inquiry', priority: 'low', status: 'resolved', message: 'Qaysi materiallar gipoallergen ekanligini bilmoqchi.', createdAt: '2026-05-25', notes: 'To\'liq ma\'lumot elektron pochta orqali yuborildi.', source: 'web' },
  { id: 'REQ-008', customerId: 'C019', customerName: 'Behruz Mamadaliyev', type: 'complaint', priority: 'high', status: 'new', message: 'Hisob-kitob summasi xato hisoblangan.', createdAt: '2026-06-05', notes: '', source: 'web' },
  { id: 'REQ-009', customerId: 'C025', customerName: 'Rustam Xudoyberdiyev', type: 'inquiry', priority: 'medium', status: 'in-progress', message: 'Maxsus buyurtma uchun qaysi to\'qimalardan foydalaniladi?', createdAt: '2026-06-01', notes: 'Ishlab chiqaruvchi bilan muloqot davom etmoqda.', source: 'web' },
  { id: 'REQ-010', customerId: 'C008', customerName: 'Shahlo Ergasheva', type: 'return', priority: 'medium', status: 'resolved', message: 'Yubka rangiga qanoatlanmadim, boshqa rang kerak.', createdAt: '2026-05-18', notes: 'Almashtirish amalga oshirildi.', source: 'web' },
  { id: 'REQ-011', customerId: 'C033', customerName: 'Lochin Nazarov', type: 'complaint', priority: 'low', status: 'new', message: 'Yetkazib berish kechikdi, 3 kun kech keldi.', createdAt: '2026-06-04', notes: '', source: 'web' },
  { id: 'REQ-012', customerId: 'C010', customerName: 'Malika Qodirova', type: 'inquiry', priority: 'low', status: 'resolved', message: 'Karta orqali to\'lash imkoniyati bormi?', createdAt: '2026-05-22', notes: 'Barcha to\'lov usullari haqida ma\'lumot berildi.', source: 'web' },
  { id: 'REQ-013', customerId: 'C041', customerName: 'Alisher Tursunov', type: 'inquiry', priority: 'low', status: 'in-progress', message: 'Birinchi xarid uchun chegirma bormi?', createdAt: '2026-06-02', notes: "Yangi mijozlar uchun 10% chegirma haqida xabar berildi.", source: 'web' },
  { id: 'REQ-014', customerId: 'C006', customerName: 'Feruza Yusupova', type: 'return', priority: 'medium', status: 'new', message: 'Libos tavsifda ko\'rsatilgandan boshqacha chiqdi.', createdAt: '2026-06-06', notes: '', source: 'web' },
  { id: 'REQ-015', customerId: 'C029', customerName: 'Mirzo Rahimov', type: 'complaint', priority: 'medium', status: 'in-progress', message: 'Hisob-faktura yuborilmagan, iltimos qayta yuboring.', createdAt: '2026-06-03', notes: 'Hisob-faktura qayta yuborildi.', source: 'web' },
]
